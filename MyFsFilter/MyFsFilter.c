...
)
{
	...
	PT_DBG_PRINT(PTDBG_TRACE_ROUTINES,
		("MyFsFilter!MyFsFilterPreCreate: Entered\n"));
	...
	if (MyFsFilterDoRequestOperationStatus(Data)) {
		...
		if (!NT_SUCCESS(status)) {
			...
			PT_DBG_PRINT(PTDBG_TRACE_OPERATION_STATUS,
				("MyFsFilter!MyFsFilterPreCreate: FltRequestOperationStatusCallback Failed, status=%08x\n",
				status));
		}
	}
...
)
{
	...
	PT_DBG_PRINT(PTDBG_TRACE_ROUTINES,
		("MyFsFilter!MyFsFilterPostCreate: Entered\n"));
...
)
{
	...
	PT_DBG_PRINT(PTDBG_TRACE_ROUTINES,
		("MyFsFilter!MyFsFilterPreClose: Entered\n"));
	...
	if (MyFsFilterDoRequestOperationStatus(Data)) {
		...
		if (!NT_SUCCESS(status)) {
			...
			PT_DBG_PRINT(PTDBG_TRACE_OPERATION_STATUS,
				("MyFsFilter!MyFsFilterPreClose: FltRequestOperationStatusCallback Failed, status=%08x\n",
				status));
		}
	}
...
)
{
	...
	PT_DBG_PRINT(PTDBG_TRACE_ROUTINES,
		("MyFsFilter!MyFsFilterPostClose: Entered\n"));
...
)
{
	...
	PT_DBG_PRINT(PTDBG_TRACE_ROUTINES,
		("MyFsFilter!MyFsFilterPreWrite: Entered\n"));
	...
	if (MyFsFilterDoRequestOperationStatus(Data)) {
		...
		if (!NT_SUCCESS(status)) {
			...
			PT_DBG_PRINT(PTDBG_TRACE_OPERATION_STATUS,
				("MyFsFilter!MyFsFilterPreWrite: FltRequestOperationStatusCallback Failed, status=%08x\n",
				status));
		}
	}
...
)
{
	...
	PT_DBG_PRINT(PTDBG_TRACE_ROUTINES,
		("MyFsFilter!MyFsFilterPostWrite: Entered\n"));
...
)
{
	...
	PT_DBG_PRINT(PTDBG_TRACE_ROUTINES,
		("MyFsFilter!MyFsFilterPreRead: Entered\n"));
	...
	if (MyFsFilterDoRequestOperationStatus(Data)) {
		...
		if (!NT_SUCCESS(status)) {
			...
			PT_DBG_PRINT(PTDBG_TRACE_OPERATION_STATUS,
				("MyFsFilter!MyFsFilterPreRead: FltRequestOperationStatusCallback Failed, status=%08x\n",
				status));
		}
	}
...
)
{
	...
	PT_DBG_PRINT(PTDBG_TRACE_ROUTINES,
		("MyFsFilter!MyFsFilterPostRead: Entered\n"));
